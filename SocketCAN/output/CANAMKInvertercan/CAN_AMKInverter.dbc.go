// Package CANAMKInvertercan provides primitives for encoding and decoding CAN_AMKInverter CAN messages.
//
// Source: CAN_AMKInverter.dbc
package CANAMKInvertercan
...
// Nodes returns the CAN_AMKInverter node descriptors.
func Nodes() *NodesDescriptor {
	return nd
}

// NodesDescriptor contains all CAN_AMKInverter node descriptors.
...
// Messages returns the CAN_AMKInverter message descriptors.
func Messages() *MessagesDescriptor {
	return md
}

// MessagesDescriptor contains all CAN_AMKInverter message descriptors.
...
// UnmarshalFrame unmarshals the provided CAN_AMKInverter CAN frame.
func (md *MessagesDescriptor) UnmarshalFrame(f can.Frame) (generated.Message, error) {
	...
	case md.AMK0_SetPoints1.ID:
		...
		if err := msg.UnmarshalFrame(f); err != nil {
			return nil, fmt.Errorf("unmarshal CAN_AMKInverter frame: %w", err)
		}
		return &msg, nil
	...
	case md.AMK1_ActualValues2.ID:
		...
		return &msg, nil
	default:
		return nil, fmt.Errorf("unmarshal CAN_AMKInverter frame: ID not in database: %d", f.ID)
	}
}
...
// Database returns the CAN_AMKInverter database descriptor.
...
var d = (*descriptor.Database)(&descriptor.Database{
	SourceFile: (string)("CAN_AMKInverter.dbc"),
	Version:    (string)(""),
